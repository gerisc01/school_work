...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\014\016\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\014\003\003\003\003\003\003\003\013\012\011\010\003\009\003\008\
...
\\000"
 ...
 (14, 
"\000\000\000\000\000\000\000\000\000\015\000\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
...
{fin = [], trans = 1},
{fin = [(N 24)], trans = 0},
{fin = [(N 22),(N 24)], trans = 4},
{fin = [(N 22)], trans = 4},
{fin = [(N 19),(N 24)], trans = 6},
{fin = [(N 19)], trans = 6},
{fin = [(N 14),(N 24)], trans = 0},
{fin = [(N 16),(N 24)], trans = 0},
{fin = [(N 10),(N 24)], trans = 0},
{fin = [(N 12),(N 24)], trans = 0},
{fin = [(N 8),(N 24)], trans = 0},
{fin = [(N 6),(N 24)], trans = 0},
{fin = [(N 4),(N 24)], trans = 14},
{fin = [(N 4)], trans = 14},
{fin = [(N 1)], trans = 0}])
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => (pos := (!pos) + 1; lex())
| 10 => (Tokens.Plus(!pos,!pos))
| 12 => (Tokens.Times(!pos,!pos))
| 14 => (Tokens.Div(!pos,!pos))
| 16 => (Tokens.Minus(!pos,!pos))
| 19 => let val yytext=yymktext() in Tokens.Int(sval(explode yytext,0),!pos,!pos) end
| 22 => let val yytext=yymktext() in let val tok = String.implode (List.map (Char.toLower) 
...
| 24 => let val yytext=yymktext() in error ("error: bad token "^yytext); lex() end
| 4 => (lex())
| 6 => (Tokens.LParen(!pos,!pos))
| 8 => (Tokens.RParen(!pos,!pos))
